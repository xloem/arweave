...
-record(nonce_limiter_info, {
	%% The total number of steps including the last one where the mining solution was found.
	length = 0,
	%% Up to ?LAST_UNLOCK_INTERVAL_NONCE_LIMITER_CHECKPOINTS evenly spaced out outputs
	%% of the last step of the nonce limiting process.
	last_step_checkpoints = [],
	%% Up to ?NONCE_LIMITER_CHECKPOINTS evenly spaced out outputs of the nonce limiting
	%% process.
	checkpoints = []
}).
